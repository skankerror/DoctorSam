...
{
private :
  EnttecInterfaces typeInterface;/* type d'interface USB Enttec */
  ...
  Rs232 portSerie;/* the serial control class for this device */
...
public :
  ...
  EnttecInterfaces GetTypeInterface() { return typeInterface; }
  string GetNomInterface() { return string(nomInterfaces[typeInterface]); }
